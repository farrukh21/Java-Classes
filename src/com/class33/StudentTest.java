...
public class StudentTest {
	public static void main(String[] args) {
		...
		Student stu2 = new Student("Jack", 103); // we created 3 objects
		students.add(stu); // we added our objects inside the arraylist
		students.add(stu1);
		students.add(stu2);
		...
		students.add(new Student("Michael", 104));// -->we can add more students directly inside this we can create new
													// objects
